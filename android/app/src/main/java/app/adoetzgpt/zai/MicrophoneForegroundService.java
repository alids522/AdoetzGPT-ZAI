...
public class MicrophoneForegroundService extends Service {
    ...
    private static final String CHANNEL_ID = "adoetzgpt_zai_mic_channel";
    private static final int NOTIFICATION_ID = 1001;

    public static final String ACTION_START = "app.adoetzgpt.zai.START_MIC_SERVICE";
    public static final String ACTION_STOP = "app.adoetzgpt.zai.STOP_MIC_SERVICE";
